function initMaps() {
  let t = { lat: 41.839595, lng: 12.712015 },
    e = { lat: 41.886383, lng: 12.492836 },
    n = new google.maps.Map(document.getElementById("map-canvas-1"), {
      center: e,
      zoom: 15,
      mapTypeId: "satellite",
      styles: [
  ...
  let a = new google.maps.Map(document.getElementById("map-canvas-2"), {
    center: t,
      zoom: 15,
      mapTypeId: "satellite",
      styles: [
  ...
  new google.maps.Marker({ position: t, map: a, title: "Casal Montani" }),
    document
      .getElementById("btn-show-content-1")
      .addEventListener("click", function () {
        document
          .getElementById("map-content-1")
          .classList.toggle("show-map-content"),
          document
            .getElementById("btn-show-content-1")
            .classList.toggle("active");
      }),
    document
      .getElementById("btn-show-map-1")
      .addEventListener("click", function () {
        document
          .getElementById("map-content-1")
          .classList.toggle("show-map-content"),
    ...
    document
      .getElementById("btn-show-content-2")
      .addEventListener("click", function () {
        document
          .getElementById("map-content-2")
          .classList.toggle("show-map-content"),
          document
            .getElementById("btn-show-content-2")
            .classList.toggle("active");
